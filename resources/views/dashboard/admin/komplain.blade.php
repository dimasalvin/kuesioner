...
<div class="card">
    ...
    <div class="table-wrap">
        <table>
            ...
            <tbody>
                ...
                @empty
                <tr>
                    <td colspan="5" style="text-align:center; color:var(--muted); padding:48px;">
                        🎉 Tidak ada komplain masuk
                    </td>
                </tr>
                @endforelse
            </tbody>
    ...
    <div class="pagination">
        @if($komplain->onFirstPage())
            <span class="page-link" style="opacity:.4;">‹ Prev</span>
        @else
            <a href="{{ $komplain->previousPageUrl() }}" class="page-link">‹ Prev</a>
        @endif
        ...
        @endforeach
        @if($komplain->hasMorePages())
            <a href="{{ $komplain->nextPageUrl() }}" class="page-link">Next ›</a>
        @else
