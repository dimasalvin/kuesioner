...
@section('title', 'Detail Penilaian Pribadi')
...
<div class="card">
    <div class="card-header">
        <div>
            <div class="card-title">📋 Riwayat Penilaian — {{ $nakes->nama }}</div>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{ route('dashboard.user.detail-penilaian-show', ['id'=>$r->id,'tipe'=>$tipe]) }}"
